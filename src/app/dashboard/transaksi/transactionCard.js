    ...
    <div className="bg-white rounded-lg shadow-md p-4 mb-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="col-span-1 lg:col-span-2">
          ...
          <p className="text-gray-600 mb-2">User ID: {transaction.userId}</p>
          <p className="text-gray-600 mb-2">Buyer: {transaction.buyer}</p>
          <p className="text-gray-600 mb-2">Date: {transaction.date}</p>
          <p className="text-gray-600 mb-2">Quantity: {transaction.quantity}</p>
          <p className="text-gray-600 mb-2">Address: {transaction.address}</p>
          <p className="text-gray-600 mb-2">Note: {transaction.note}</p>
